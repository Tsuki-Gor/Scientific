...
<!-- figureText: Physical World Virtual World The Emerging Agent AI Paradigm for Multi-modal and Cross-Reality AGI Agent Paradigm Embodiment Product Generalist Autonomous Vehicle Gaming Agents Autonomous Manufacturing AI Copilots Vehicles Assistant Embodied System AI for Health LLMs VLMs Primitive- Actuators Security action system Planning capabilities Mechanical arm Robotics Human Reasoning system Controller Interaction Generative AI Memory Brain-Computer Interface 3D Objects / Environment User/Agent Input Smart sensors Specific Tactile sensors Agent Action Perception Info Reasoning Efficiency Consciousness Intelligence Mechanics Optimization Cognition Neuro-Symbolic Science Learning Agent (Pretraining, Zero-shot, few-shot from LLM and VLM, etc.) Interactive Closed-loop Memory (Knowledge, Logic, Reasoning, and Inference) Service Robots Virtual Reality Application Ambient Mixed Reality Virtual Avatar Intelligence Augmented Reality GUI App Cameras Multi-modal Social networks sensors Audio Simulators Infra- structure Microphones Cloud Servers Multi-Agent Planning Physical Video Knowledge Experiments Observations Human Activity Speech Big data Training Philosophy of mind Theory ML Theory Physics Informatics Task-Planning and Skill-Observation Agent Environment Perception Controller Cognition Action (Thinking, Consciousness, Sensing, Empathy, and overall Cognitive System) -->
...
<!-- figureText: Physical-World Interaction Multi-Modality Agent Multi-model Agent & Cross-Reality Agent for 2D/3D Embodied Generation and Editing Interaction Virtual-Reality Agent Simulator/Mixed-Reality/Metaverse/Product ChatGPT Game Engine GPT-X Interaction Mesh-Teams & Microsoft Gaming Generate Avatar virtual attendees VirtualHome Simulation with GPT4 Game Engine GPT4 Editing Game Engine Microsoft Flight Simulator Video game series 3D Gaming Scenario Cross-Reality Human DallE-2 Knowledge Agent QA Instruction Q: What technology is used in the Scene with conference room? conference room A: The conference room is equipped with a video conferencing device. complete with a office chairs, GPT-X whiteboard, and New Text: The conference room is equipped with a projector. projector and whiteboard and includes a conference table with four office chairs, whiteboard, and projector, and is set up for video conferencing Multi-modality Knowledge Interaction Human DallE-2 Knowledge Agent QA GPT4 Instruction Q: What's color of this bus? A: Blue Abus is going down the street GPT-X and it has an New Text: A blue bus is advertisement going down the street on the side of it. and it has an advertisement on the side of it. -->
...
<!-- figureText: Interactive Agent Unseen Environment Agent AI -Reality LLM or VLM Agent Prompt Physical World Virtual Reality 2D: Dall-E, GPT4-V ChatGPT/GPT-4 & Game Engine Cross-reality Agent Image Action Knowledge Interact Info. Knowledge- Multi-modality Agent Memory: Tensor-Contrastive Learning Training GPT4-V, DALLE-2 -->
...
<!-- figureText: Initial environmental A sequence of Prepared manually Online robot teaching interface Realtime camera view Robot [idle]: Hello. What can I do for you today? Robot [Idle]: It seems that your intention is: StartTeaching. Is that correct? User. Yes Robot [StartTeaching]: What should I do? User: Move the cup to the bottom of the shelf understand that the action is broken down as follows. 1: move the hand near the cup. 2 grasp the cup. 3 pick up the cup. 4: take the cup from the top shelf. 5: move the cup downwards. 6: move the cup into the bottom shelf. 7: place the cup on the bottom shelf. 8: release the cup. Is that correct? Robot [StartTeaching]: Please do step-by-step move the hand near the cup. Recording started representation instructions Task planning (the scope of this paper) User creates an action sequence up to a desired operational step using the proposed task planner User confirms the resulting action sequence Demonstration User gives visual demonstration for each task Vision systems gather parameters for robot task execution Robot execution User checks the robot operation in simulation 2. User checks robot operation in a real setup (with emergency stop button) ① Providing language feedback for the correction of task planning ② Redoing the visual demonstration ③ Redoing the task plan when robot execution fails, or starting the next task plan when robot execution succeeds -->
...
<!-- figureText: Task-Planning and Skill Observation Learning Agent (Pretraining, Zero-shot, few-shot from LLM and VLM, etc.) Interactive Closed-loop Memory (Knowledge, Logic, Reasoning, and Inference) Environment Perception Controller Cognition Action (Thinking, Consciousness, Sensing, Empathy, and overall Cognitive System) -->
...
<!-- figureText: LLM/LVM Agent Output tokens Language tokens LLM / LVM Transformer Visual tokens -->
...
<!-- figureText: Next Token Prediction Agent Multi-modal Transformer Visual tokens Language tokens Input Vectors Agent tokens -->
...
<!-- figureText: designated crafting area. GPT-4V may proceed to the next part of their adventure. Yes, please generate it GPT-4V a generate the future action in this context would involve predicting the next steps within the game. GPT-4V GPT-4V -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_630144.jpg"/>
...
<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_a165ea.jpg"/>
...
<!-- figureText: Unseen Video Prediction Results reconstruction reconstruction + visible reconstruction reconstruction + visible reconstruction original masked original masked masked -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_72c3c4.jpg"/>
...
<!-- figureText: Action Original Masked Reconstructed Image (input) Image (output) masked reconstruction masked reconstruction masked reconstruction Predictions Image [startaction][forward][right] Forward Right [startaction][right] Right _____. [startaction][right] Right Forward Jump -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_efd8fe.jpg"/>
...
<!-- figureText: Planning Skills & Tool Use LLM Dispatcher Memory Text Current State Update Info. Agent state State Memory History Environment state Environment Environment state history MindAgent feedback Interaction GPT-4 Agent state Trajectory history Update Prompt Action Actions history Recipes Instructions Feedback Inference history knowledge One-shot demo CuisineWorld State Extraction Agent location Game Info. Tool state Agent holdings CuisineWorld Pending dishes Gaming Environment Timer Action Human Actions Controller Action Extraction Multi - Agents Action List of action types Validation Pattern for the actions Domain specific Extraction full NPC Human language action names from Collaborators Player the returned tuples -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_70cf8a.jpg"/>
...
<!-- figureText: ChatGPT-empowered task planning Skill parameterization from demonstration Visual demonstration Vision analyzer Parameterized tasks: "grasp_object(<juice>)": \{ 3D position of the object: $\left\lbrack  {x,y,z}\right\rbrack$ Handless of the manipulation: "right" Approach direction to the object: $\left\lbrack  {x,y,z}\right\rbrack$ Grasp type: "power", ... Instruction: "Put the juice on top of the shelf." Environmental description: "<spam>": "on_something(<table>)", "<juice>": on_something(<shelf_bottom>)" Pre-defined ChatGPT prompt Task sequence with explanations: "move_hand(   )", # move the hand near the juice, "grasp_object(   )", # grasp the juice "move_object(<juice>)", # take the juice from the bottom shelf "move_object(<juice>)", # move the juice upward "put_down_object(<juice>)", # place the juice on the shelf "release_object(<juice>)" # release the juice \} -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_b6abd4.jpg"/>
...
<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_1011f9.jpg"/>
...
<!-- figureText: Text input Edit textual instruction Task Symbolic planner task plan Environmenta GPT-4 description GoFT-4V Video analyzer Video demonstration Scene analyzer -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_0b15f3.jpg"/>
...
<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_b760cb.jpg"/>
...
<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_c422d7.jpg"/>
...
<!-- figureText: on the table, grab it, and then place it on the tray nearby." GPT-4V "objects": ["<can>", "<table>", "<tray>"], "object_properties": \{ "<can>": ["GRABBABLE"], "<table>": [], "<tray>": [] \}, "spatial_relations": \{ "<can>": ["on(<table>)"], "<table>": [], "<tray>": ["on(<table>)"] \}, "your_explanation": "The human is expected to grab the can that is on the table and place it on the tray. The table and the tray are included as they are the surfaces involved in this action. The can is marked as GRABBABLE because it is the item being manipulated. Other objects and details in the environment not related to the action, such as the human, the background elements, and the clothing, are omitted because they do not influence the task of moving the can from table to tray." hand to the fridge handle, grab it, and open the fridge door." GPT-4V "objects": ["<fridge>", "<fridge_handle>"], "object_properties": \{ "<fridge>": [], "<fridge_handle>": ["GRABBABLE"] \}, "spatial_relations": \{ "<fridge_handle>": ["on(<fridge>)"], "<fridge>": [] \}, "your_explanation": "Human is moving their hand to the fridge handle, grabbing it, and opening the fridge door. Objects included are the fridge and fridge handle, as they are directly involved in the action. I omitted the computer monitor and other unmanipulated objects in the setting because they are not being interacted with for this task." -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_158770.jpg"/>
...
<!-- figureText: Instruction Local Global trajectories in top-down view Turn right and head visual towards the kitchen. scene Then turn left, pass a table and enter the hallway. Walk down the hallway and turn into the entry way to your right without doors. Stop in front of the toilet. Initial Position Target Position Demonstration Path A Executed Path B Executed Path C -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_ab28c7.jpg"/>
...
<!-- figureText: What is happening in this image? What is this a picture of? What do you see in the following image? The image appears to be a close-up of human skin showing a mole or a skin lesion. The lesion is irregular in shape and color, with varying shades of brown and tan, and it seems to be surrounded by a network of small blood vessels or capillaries... Would you classify the skin lesion as malignant or benign? appear to be irregular. The normal pattern of a heartbeat on an ECG I'm unable to provide medical shows a P wave, a QRS complex, diagnoses. Assessing whether a ECG, there are additional spikes skin lesion is malignant or benign and variability in the height of the requires professional medical evaluation... In the image, there are two This is an image of an healthcare professionals in a electrocardiogram (ECG or EKG) clinical setting, standing next to a printout... medical imaging machine, which appears to be a CT (Computed Tomography) scanner. One is Do the wave patterns appear wearing a white coat, typically regular or irregular? worn by doctors, and the other is in scrubs, attire commonly worn by nurses or medical technicians. They seem to be preparing or The wave patterns in the ECG assisting a patient who is lying on the scanning bed of the ${\mathrm{C}}^{ * }$ machine, possibly getting ready for a scan. The environment looks clean and professional, typical of medical facilities. waves... -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_ba1131.jpg"/>
...
<!-- figureText: Frame Frame What is happening in the video? The image you've uploaded appears to be a compilation of four frames from an ultrasound assisting a patient with a standinc frames as indicated by the labels Frame 0, Frame 1, Frame 2, and Frame 3. Ultrasound imaging is a This is a common bedside activity common diagnostic tool used in medicine to visualize internal... This is an echocardiogram, do you notice anything abnormal? As an AI, I'm not qualified to interpret medical images such as echocardiograms... Which clinical bedside activity is Which clinical bedside activity is occurring in the video? occurring in the video? The images you've shared appear The sequence of images appears to be frames from a video that to show a healthcare provider demonstrates the process of turning a patient in bed, likely to pivot transfer from a hospital prevent bedsores or for comfort. bed to a chair or wheelchair. This is a common procedure in hospital settings, where patients in healthcare settings, where a may be immobile or bedridden for patient who has limited mobility extended periods. The activity is needs assistance to be safely typically done by healthcare moved from the bed to a chair... professionals to maintain the patient's skin integrity and to promote circulation. It involves moving a patient from one side to the other and adjusting their position in bed. -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_2a1be8.jpg"/>
...
<!-- figureText: Interaction Audio Customized Pre-trained Agent Vision Language Identify and analyze via Structured/ images, videos unstructured text LLM/VLM Agent Interactive Action Integrate audio /Knowledge/Cognition processing -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_c96ada.jpg"/>
...
<!-- figureText: INK Visual Knowledge: Wiki: Rash Guard is stretch garment for protection from abrasion, UV and stings. ConceptNet: Surfer is... capable of riding the waves. Text Knowledge: Wiki: Safety is state of being secure from harm, injury, danger or risk. Wiki: Surfing is sport that consists of riding waves. Image ${V}_{i}$ Positive Text: The man usually takes all safety precautions when surfing. Negative Text 1: He fell during surfing. Negative Text 2: This man is going to use the wind to ride the waves. Human Annotation Knowledge: Surf String prevents surfboard from being swept away by waves and stops runaway surfboards from hitting others. Gear is capable of keeping you safe. -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_a5bae8.jpg"/>
...
<!-- figureText: Image Implicit Knowledge: Candidate + Evidence Encoder Transformer m+1 Reasoning Decoder A: Module Transformer Washington Encoder Transformer Image Object detection Object Tag GPT-3 Image Image Caption B-Box Feature Q: What monument is that? Wikidata Contrastive Explicit Learning Knowledge : Based Entities + Des Module -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_811eb2.jpg"/>
...
<!-- figureText: [CLS] Patch masks Token position embedding [MASK] Token masks Patch position embedding Modality-specific embedding ITM head Match or not Multi-layer MLM head branch Transformer MIM head Multimodal Task-specific Encoder Decoder The yellow The and blue bird Word is standing on embedding a branch a [MASK] Linear Projection Modality-specific Projection -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_3b4bcb.jpg"/>
...
<!-- figureText: What would you recommend for this person to do to Provide a short description of the scene Red fox running in the snow What does the fox do at the end? Jump. feel better? In the image, there is a person sitting on a bench in a park with a friend. The person is wearing a blue shirt and a pair of blue jeans. The person is holding a bottle of person is looking at the camera and smiling to the camera. The person may be feeling depressed, anxious, or stressed due to a recent event or situation. The person may want to take a break from their busy schedule and relax for a while. They may want to take a walk, read a book, listen to music, or take a nap to help them feel better. The person may also want to talk to a trusted friend or family member to share their feelings and -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_93ec2e.jpg"/>
...
<!-- figureText: Video Frames VideoChat Summary The video shows a man wearing a blue shirt who is holding a yellow pole and demonstrating how to use it. He is seen holding the pole and talking to the camera while explaining the process. The man is wearing a blue shirt and is holding a yellow pole. He is seen holding the pole and talking to the camera while explaining the process. GPT-4V Summary with Frame Captions In the video, a man appears in a series of sequences where he interacts stick at his side, presenting it like a novelty item. As the video progresses he engages more actively with the stick, extending it outward as if sizing up some unseen object or distance. In a playful twist, he bites down on it while holding it horizontally, showcasing a humorous approach to what might be a mundane task. Throughout the video, the man's demeanor suggests he's involved in a light-hearted activity, possibly a humorous take on measurement and scale in an everyday suburban setting. The background with cars, greenery, and signage for a dental clinic remains consistent, anchoring the sequence of events in a single location and providing a casual, almost candid atmosphere to the activities unfolding GPT-4V Video Summary with Frame Captions + Audio The video is a tutorial on how to measure the height of a tree using a simple method with a broomstick. The instructor demonstrates how to hold the broomstick perpendicular to the body and rotate it down so that when it's parallel to the eye, the length of the broomstick is adjusted accordingly. The stick is then flipped back up and held perpendicular again. The distance from the hand to the eye is said to be equal to the distance from the hand to the end of the stick. The instructor then explains how to use this measurement to create an isosceles triangle when sighting the bottom of the tree with one eye and aligning the top of the tree with the top of the stick. This alignment allows the measurer to determine that the are exactly as far from the tree as the tree is tall. Finally, the instructor of the tree with a tape measure to find the height of the tree, completing the measurement process. GPT4-V Frame Captions A man with a serious A man in a "New York City" t- A man is humorously biting a large expression stands holding a shirt holds a tall, yellow yellow measuring stick while extending yellow measuring stick in a measuring stick upright in a it with his left arm in a parking lot with parking lot, with a car and sunny parking lot setting. a backdrop of greenery and a car. trees in the background. Audio ASR Transcriptions you rotate the This is your tree height broomstick down like this and you you hold your hand out like this adjust the length of the measuring lesson so I perpendicular to your body and broomstick such that the top of have an ordinary holding the broomstick like that. the broomstick this point right broomstick here. here is parallel with your eye -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_daa56d.jpg"/>
...
<!-- figureText: Original Text: Stackoverflow Q: "How to measure the height of the tree?" High-level: Whole Video-Level MC this and you adjust the length of the broomstick such that the top of the broomstick this point right here is GPT-4V Hallucinations: parallel with your eye A man is humorously biting a large yellow measuring stick GPT-4V 1. "Measure width of tree" 2. "Measure distance between two trees' while extending it with his left 3. "Measure height of car arm in a parking lot with a 4. "Measure length of stick" backdrop of greenery and a GPT-4V Knowledge/Inference/ GPT-4V Video Summary with Frame Captions + Audio The video is a tutorial on how to measure the height of a tree using a simple method with a broomstick. The instructor demonstrates how to when it's parallel to the eye, the length of the broomstick is adjusted accordingly. The stick is then flipped back up and held perpendicular again. The distance from the hand to the eye is said to be equal to the distance from the hand to the end of the stick. The instructor the explains how to use this measurement to create an isosceles triangle the tree with the top of the stick. This alignment allows the measurer to determine that they are exactly as far from the tree as the tree is tall Finally, the instructor advises to measure the distance from the point on the ground to the base of the tree with a tape measure to find the heigh of the tree, completing the measurement process. Bing Search Video: Audio: Frame $/$ Image : ASR Transcription: measuring lesson so I have an perpendicular to your body and ordinary broomstick here. holding the broomstick like that. A man with a serious Frame expression stands holding shirt holds a tall, yellow a yellow measuring stick measuring stick upright in a Captioning: in a parking lot, with a car sunny parking lot setting. and trees in the - Second I to 5: A bald man in a blue shirt is standing next to a black car parked on a street Low-Level: Video-Segment Level MC Human Interaction Q: "How to use the tool?" Memory Agent Interaction Agent: Given any frame and audio Transcriptions from the video, answer the question in 4-way multiple choice setting -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_4f8763.jpg"/>
...
<!-- figureText: General Alpaca Training Framework Pre-trained Alpaca Open-source LLM Supervised Instruction-following Fine-tuning examples Example Generated Task: Instruction: Describe ways you can play in the snow.. You could have a snowball fight, go sledding, build a snowman.. Larger, proprietary or closed-source LLM Modified Self-instruct Instruction Generation Self-Instruct seed tasks Example: Instruction: Brainstorm a list of good tropical island vacation destinations. Output: Output: Hawaii Mauritius Seychelles -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_09823a.jpg"/>
...
<!-- figureText: logic logic keyword conjunction logic component conjunction logic component pork dumplings and beef noodles Hsoc_3 Hsoc_3 Hsoc_3 Hsoc_3 Hsoc_3 Lconj_key Lconj_1 Lconj_1 Loonj_key Lconj_2 Lconj_2 + Epork Edumplings Eand Ebeef Enoodles P6 ${P}_{7}$ P8 P9 ${\mathrm{P}}_{10}$ keyword logic-generic part Input: like to eat both Higher-Order Logic Hsoc_3 Hsoc_3 Hsoc_3 Hsoc_3 Hsoc_3 Embeddings First-Order Logic Embeddings Lgeneric Lgeneric Lgeneric Lgeneric Word ${\mathrm{E}}_{\mathrm{i}}$ Elike Eto Eeat Eboth Embeddings Position Embeddings P1 ${\mathrm{P}}_{2}$ P3 P4 ${P}_{5}$ -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_5379df.jpg"/>
...
<!-- figureText: q Action $\left( {q,{p}_{i}}\right)$ Environment q ${p}_{i}$ sampling Reward r Reader Model Agent (Frozen) ${P}_{i}$ 10100g $\left( {\mathrm{q},{\mathrm{p}}_{\mathrm{i}}}\right)$ Reader Model a’. Loss(a, a’) answer a aseud Retriever 10100gBS әgpәjmouy WIKIPEDIA The Free Encyclopedia ${d}_{\mathrm{n}}$ q , aseud Retriever (uәzou-j) WIKIPEDIA The Free Encyclopedia ${d}_{n}$ -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_eebdee.jpg"/>
...
<!-- figureText: In [134]: n = 2.0 f" The current action is moving to the right, and moving forward. The goal is to craft a crafting table. Please describe the future actions" I fps = 20 start_frame = int(950) end_frame = int( 950 + fps * n) start = int(start_frame/fps.0) end = int(end frame/14.0) frames=base64Frames[start_frame:end_frame] display_handle = display(None, display_id=True) for img in frames: display handle.update(Image(data=base64.b64decode(img.encode("utf-8"))) time.sleep(0.025) 注 _____16_____ actions = json.load(f) #print(actions[100:102]) min_ticks = start max_ticks = end action_frames = [d for d in actions if min_ticks <= d['ticks'] <= max_ticks] for dictionary in action frames: if key_to_delete in dictionary: del dictionary[key_to_delete] #print(action_frames) In [141]: ewButtons":[]\},"keyboard":\{"keys":["key.keyboard.d","key.keyboard.w"],"newKeys":[],"chars":""\},"isGuiOpen":false,"isGuiInven In [146]: H IESSAGES $=$ [ "role": "system", "content": [ ], "role": "user", "content": [ *map(lambda x: \{"image": x, "resize": 768\}, frames[0:2]), ], lel": "gpt-4-vision-preview", sages": PROMPT_MESSAGES, : tokens": 2000, PROMPT_MESSAGES) 47]: H result = client.chat.completions.create(**params) print(result.choices[0].message.content) Since you've collected wood, the next steps to craft a crafting table in Minecraft are as follows: 1. **Open your inventory** (`E` key by default) to bring up the crafting screen. 2. **Place the wood logs** you've collected into one of the crafting slots to turn them into wooden planks. Each log will cr eate 4 wooden planks. 3. **Collect the wooden planks** that you've created by dragging them into your inventory. 4. **Fill all four crafting slots** in the 2x2 crafting grid (available in your inventory screen) with wooden planks to compute 5. **Collect the crafting table** by dragging it into your inventory. 6. Close your inventory and **select the crafting table** in your hotbar. 7. **Right-click on the ground** to place the crafting table. Once the crafting table is placed,you can interact with it to use the $3 \times  3$ crafting grid for creating a wide array of more constant of the constant omplex items. That's the basic process for crafting a crafting table in Minecraft. Now you're ready to begin crafting more a dvanced items and tools. -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_f56e0e.jpg"/>
...
<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_931aa8.jpg"/>
...
<!-- figureText: CVTR AIR SPEED TOO LOW Increase airspeed above 91.0 knots to avoid a stall OPPERPOSTIOF COM1:KONA120.300 COM2:Not in...12 ZOOM LEVEL SMARTCAM TARGETS $- \left\lbrack  \text{ TUNE KONA ATIS ON 127.400 }\right\rbrack$ -INSTRUMENT $2 \cdot  \left\lbrack  {-\mathrm{{BACK}} - }\right\rbrack$ -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_d4b23b.jpg"/>
...
<!-- figureText: Hold $\Delta$ and press $Q$ for Bull Rush Ability -->



<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_a7768d.jpg"/>
...
<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_1e3783.jpg"/>
...
<img src="https://raw.githubusercontent.com/Tsuki-Gor/Pic_Bed_Ob/main/Mixed/M2025/10/2025_10_06__22_15_31_e60924.jpg"/>
